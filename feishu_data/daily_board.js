window.DAILY_BOARD = {
  ...
  "inspirations": {
    ...
    "today_updated": false,
    "done_map": {
      "inspiration:ima 知识库，一个共享知识库里的内容，是否可以部分开放？比如有人买读书笔记，我就只开放这几个文件夹📂，有人买产后恢复运动，我就开放相应的文件——不能隐藏文件夹，只能隐藏单个文件": true,
      ...
      "task:扫地": true,
      "task:找之前的排卵监测报告，看内膜长的情况": true,
      "task:看不二的个人网站，学习一下": true,
      "task:把这台 Mac 的数据都迁移到新 Mac，以后用新 Mac": true,
      "task:晚上给杜爽爽视频问国庆要不要去马来西亚": true,
      "task:缴7月社保": true,
